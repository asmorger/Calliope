...
namespace Calliope
{
    public readonly struct Optional<TValue> : 
        IEquatable<Optional<TValue>>,
        IComparable<Optional<TValue>>,
        ...
        IStructuralComparable
    {
        ...
        public override bool Equals(object obj) => obj is Optional<TValue> other && Equals(other);

        public bool Equals(Optional<TValue> other) => Equals(other, EqualityComparer<TValue>.Default);
        ...
        private bool AreBothNone(Optional<TValue> other) => !(_isSome || other._isSome);

        private bool AreBothSome(Optional<TValue> other) => _isSome && other._isSome;
        ...
        public int CompareTo(Optional<TValue> other) => CompareTo(other, Comparer<TValue>.Default);
        ...
        public static bool operator ==(Optional<TValue> a, Optional<TValue> b) => a.Equals(b);
        public static bool operator !=(Optional<TValue> a, Optional<TValue> b) => !(a == b);
        public static bool operator <(Optional<TValue> a, Optional<TValue> b) => a.CompareTo(b) < 0;
        public static bool operator >(Optional<TValue> a, Optional<TValue> b) => a.CompareTo(b) > 0;
        public static bool operator <=(Optional<TValue> a, Optional<TValue> b) => a.CompareTo(b) <= 0;
        public static bool operator >=(Optional<TValue> a, Optional<TValue> b) => a.CompareTo(b) >= 0;

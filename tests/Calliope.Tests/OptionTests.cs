...
namespace Calliope.Tests
{
    ...
    {
        [Fact]
        public void Some_implements_some_or_none() => Assert.Equal(42, new Some<int>(42).ValueOrFallback(() => 0));

        [Fact]
        public void Some_has_value_returns_true() => Assert.True(new Some<int>(42).HasValue); 
        
        [Fact]
        public void None_implements_some_or_none() => Assert.Equal(42, new None<int>().ValueOrFallback(() => 42));
